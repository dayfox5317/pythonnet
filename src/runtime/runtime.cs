...
#error You must define one of PYTHON34 to PYTHON37 or PYTHON27
        ...
        [DllImport(_PythonDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr PyNumber_Divide(IntPtr o1, IntPtr o2);
        ...
        [DllImport(_PythonDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr PyNumber_InPlaceDivide(IntPtr o1, IntPtr o2);
        ...
        [DllImport(_PythonDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int PyBytes_Size(IntPtr op);
        ...
        public static extern IntPtr PyString_FromStringAndSize(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8Marshaler))] string value,
            int size
        );

        [DllImport(_PythonDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr PyUnicode_FromStringAndSize(IntPtr value, int size);
#elif PYTHON2
        [DllImport(_PythonDll, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(_PythonDll, CallingConvention = CallingConvention.Cdecl)]
        public static extern int PyUnicode_GetSize(IntPtr ob);
        ...
        public static extern IntPtr PyUnicode_FromUnicode(
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UcsMarshaler))] string s,
            int size
        );
        ...
        //[DllImport(_PythonDll, CallingConvention = CallingConvention.Cdecl)]
        //public static extern IntPtr PyDescr_NewMethod(IntPtr type, ref PyMethodDef method);
